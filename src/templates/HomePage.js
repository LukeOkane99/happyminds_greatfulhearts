...
export const HomePageTemplate = ({ 
  ...
  <main className="Home">
    ...
    <section className="section">
      <div className="container">
        <h2>Gallery</h2>
        <p>We are always uploading new media to our <a href="https://www.facebook.com/happymindsgratefulhearts/photos/?ref=page_internal" target="_blank" rel="noreferrer" style={{color: '#00c7c7', textDecoration: 'none'}}>Facebook</a> page so please feel free to keep up to date with us there and like our page!</p>
